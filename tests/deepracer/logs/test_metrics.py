...
class TestMetrics:
    ...
    def test_load_metrics(self):
        tm = TrainingMetrics(
            None,
            fname="./deepracer/logs/sample-console-logs/metrics/training/"
    ...
    def test_load_multiple_metrics(self):
        ...
        tm = TrainingMetrics(
            None, fname="./deepracer/logs/sample-drfc-3-logs/metrics/TrainingMetrics.json"
        )
        tm.addRound(
            None,
            fname="./deepracer/logs/sample-drfc-3-logs/metrics/TrainingMetrics_1.json",
            training_round=1,
            worker=1,
        )
        summary = tm.getSummary(method="mean", summary_index=["r-i", "master_iteration"])
